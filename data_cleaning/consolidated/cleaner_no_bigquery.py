...
unique_repos_case_insensitive = set({v.casefold(): v for v in unique_repos}.values())
...
with open("data_cleaning/consolidated/unique_repos_no_bigquery3.txt", "w") as f:
    for r in sorted(unique_repos_case_insensitive):
        f.write(r + "\n")
